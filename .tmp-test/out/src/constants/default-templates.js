...
exports.defaultLegacyPlans = exports.defaultPhotos = exports.defaultStories = exports.defaultMembers = void 0;
const enums_1 = require("./enums");
exports.defaultMembers = [
    {
        id: 'm-ancestor',
        name: '林启明',
...
exports.defaultStories = [
    {
        ...
        mediaUrls: [],
        category: enums_1.StoryCategory.MEMORY,
        date: '1954-07-12',
        isPublic: true
    },
    {
        ...
        mediaUrls: [],
        category: enums_1.StoryCategory.TRADITION,
        date: '1978-04-05',
        isPublic: true
    }
];
exports.defaultPhotos = [
    {
        id: 'p-1',
        uploaderId: 'm-mother',
        memberId: 'm-grandma',
...
exports.defaultLegacyPlans = [
    {
        id: 'l-1',
        memberId: 'm-father',
        type: enums_1.LegacyType.DIGITAL_ASSET,
